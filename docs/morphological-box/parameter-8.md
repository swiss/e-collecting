...
block
  block
    ...
    t2["Variantes"]:3
    d["Paramètre 8
      Garantir un délai de réflexion 
      avant la transmission de la
      déclaration de soutien"]
    a1["Variante 1:
      La déclaration de soutien 
      est transmise immédiatement
      "]
    a2["Variante 2:
      La déclaration de soutien
      n'est transmise qu'après un 
      délai de réflexion et une
      confirmation
      "]
    a3["Variante 3:
      La déclaration de soutien est
      transmise exclusivement lors
      d'un échange personnel sur
      place
      "]
...
block
  block
    ...
    d["Parameter 8
      ...
      Bedenkzeit vor Übermittlung 
      der Unterstützungsbekundung"]
    a1["Ausprägung 1:
      Unterstützungsbekundung wird
      sofort übermittelt"]
    a2["Ausprägung 2:
      Unterstützungsbekundung wird
      erst nach einer Bedenkzeit
      und einer Bestätigung
      übermittelt"]
    a3["Ausprägung 3:
      Unterstützungsbekundung aus-
      schliesslich im persönlichen
      Austausch vor Ort"]
    style t1 fill:#a8d5ff,stroke-width:0px
    style t2 fill:#a8d5ff,stroke-width:0px
    style d fill:#a8d5ff,stroke-width:0px,text-valign:top

...
block
  block
    ...
    t2["Ausprägungen"]:3
    d["Parameter 7
      Administrative Voraus-
      setzungen für Teilnahme
      an E-Collecting Versuchen"]
    a1["Ausprägung 1:
      Anmeldung zu E-Collecting,
      mit Verzicht auf Papier
      (= Opt-Out)"]
    a2["Ausprägung 2:
      Anmeldung zu E-Collecting 
      ohne Verzicht auf Papier
      (= Opt-In)"]
    a3["Ausprägung 3:
      Automatischer Zugang zu
      E-Collecting ohne 

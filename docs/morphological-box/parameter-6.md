...
block
  block
    ...
    d["Parameter 6
      ...
      föderalen Ebenen"]
    a1["Ausprägung 1:
      Beschränkung des Einsatzes auf
      Initiativen und Referenden auf 
      Bundesebene"]
    a2["Ausprägung 2:
      Einsatz auf eidgenössischer,
      kantonaler und kommunaler Ebene, 
      bei einer Beschränkung auf
      Initiativen und Referenden mit 
      dem Bund entsprechenden 
      rechtlichen Gegebenheiten"]
    a3["Ausprägung 3:
      Einsatz bei Bund, Kantone und 
      Gemeinden mit zusätzlicher 
      Unterstützung für Initiativen und 
      Referenden mit unterschiedlichen 
      Parametern wie Ausländerstimmrecht
      oder Stimmrechtsalter 16"]
    a4["Ausprägung 4:
      Einsatz bei Bund, Kantonen und 
      Gemeinden, Gemeindeverbänden, 
      Schul- und Kirchgemeinden etc. 
      inklusive der zusätzlichen Abdeckung 
      von weiteren Formen von Volksbegehren 
      jenseits von Initiativen und 
      Referenden (beispielsweise Unter-
      stützungsbekundungen durch 
      juristische Personen, Volksbegehren 
      ohne Sammelfristen)"]

...
# Résumé de la 4ème manifestation en ligne du 3 juin 2026</a>
...
## Christian Folini (Bundeskanzlei): Teilrevision des Bundesgesetzes über die politischen Rechte (BPR)

* Teilrevision «Bundesgesetz über die politischen Rechte» (BPR) wurde am 12. März 2026 im Ständerat als Zweitrat behandelt.
* Zurzeit bestehen Differenzen zwischen den zwei Räten bezüglich der örtlichen Beschränkung der E-Collecting-Versuche, einer Orientierung an den Prinzipien der Datensparsamkeit und der Quelloffenheit sowie der dezentralen Bescheinigung des Stimmrechts.
* Erneute Behandlung im Nationalrat am 4. Juni 2026

## Christian Folini (Bundeskanzlei): Zeitplan partizipativer Prozess

* Anfang Juli 2026: Publikation sämtlicher Parameter des morphologischen Kastens einschliesslich der Umsetzungsvarianten
* 19.August 2026: 5. Online-Veranstaltung zum vollen morphologischen Kasten und Umsetzungsvarianten
* Bis Ende September 2026: schriftlicher Dialog zum morphologischen Kasten inkl. der Umsetzungsvarianten.
* Mögliche Nachbearbeitung des morphologischen Kastens und danach eine zweite Diskussionsrunde zu den Umsetzungsvarianten und zum morphologischen Kasten
* Im Anschluss: Variantenentscheid Bundeskanzlei

## Christian Folini (Bundeskanzlei): DigitalBarometer 2026

* Die am 26. Mai 2026 veröffentlichten Ergebnisse des diesjährigen DigitalBarometers zeigen, dass die Schweizer Bevölkerung der Digitalisierung zunehmend kritisch gegenübersteht.
* Das Vorhaben bewegt sich also in einem Umfeld, welches der Digitalisierung der Volksrechte wie etwa E-Collecting kritisch gegenübersteht.

## Natalie Schnelle (Bundeskanzlei): Stand morphologischer Kasten 

*	Es handelt sich um eine Methode zur systematischen Analyse komplexer Problemstellungen 
*	Ziel der Methode: Zerlegung des Problems in verschiedene Einzelparameter
*	Parameter: Aspekte einer Lösung, die unterschiedlich ausgestaltet werden können. Für jeden Parameter werden möglich Ausprägungen definiert. 
*	Kombination der Ausprägungen ergibt verschiedene Lösungsvarianten, welche anschliessend analysiert werden können. 

# Gruppendiskussion zu einzelnen Parametern 

Die zehn Parameter einschliesslich ihrer Ausprägungen, die bereits im schriftlichen Dialog publiziert worden waren, wurden in sechs Kleingruppen vertieft diskutiert. Jede Kleingruppe bearbeitete dabei drei bis vier Parameter.

Die folgende Zusammenfassung basiert auf dem Feedback der einzelnen Kleingruppen im Plenum, aber auch auf den schriftlichen Notizen der Moderatoren der Kleingruppen.
...
*	Ausprägung 1 könnte allenfalls entfallen, da es politisch kaum vertretbar wäre, Mehrfachunterschriften nicht erkennen zu können. Wird Ausprägung 1 beibehalten, hat dies Auswirkungen auf Parameter 1.2. Dieser müsste um eine zusätzliche Ausprägung ergänzt werden, die den Fall berücksichtigt, dass keine Erfassung erfolgt. 
...
*	Vorschlag Umformulierung Ausprägung 2: Statt «kanalübergreifend» sollte, «stimmregisterübergreifend» verwendet werden, um Mehrfachunterschriften bei einem Umzug von Stimmberechtigten zu verhindern.
